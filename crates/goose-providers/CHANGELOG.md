...
## [0.1.0-alpha.11](https://github.com/dongphuongman/goose/compare/gdk-v0.1.0-alpha.10...gdk-v0.1.0-alpha.11) - 2026-09-26

### Fixed

- *(databricks_v2)* send Claude model services through the Anthropic route ([#12486](https://github.com/dongphuongman/goose/pull/12486))
